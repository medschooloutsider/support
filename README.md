...
Entitlement adapters currently cover both Lemon Squeezy license checks and Apple receipt validation.

## Local Development

1. Copy `.env.example` to `.env.local`.
2. Fill Supabase, Lemon Squeezy, `APPLE_RECEIPT_SHARED_SECRET`, owner email, and app-origin secret values.
3. Run `npm run dev`.
